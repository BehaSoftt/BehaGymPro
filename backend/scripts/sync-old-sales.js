                ...
                where: {
                    ...
                    [Op.or]: [
                        ...
                        { salesTransactionId: sale.id },
                        {
                            createdAt: {
                                [Op.between]: [
                                    new Date(sale.createdAt.getTime() - 10000), // Satıştan 10 saniye önce/sonrası
                                    new Date(sale.createdAt.getTime() + 10000)
                                ]
                            }
                        }
                    ]
...
// Env dosyasını backend klasöründe aramak için path ayarı gerekebilir
syncOrphanedSales();
